...
# Adapted by Jaxine Wolfe from post-processing script written by James Holmquist
# This function iterates through a data frame, which is created under V2 guidance
# and is intented to be used in the hook scripts prior to synthesis
...
# input the tables necessary to assign quality tiers
assignTiers <- function(cores, depthseries){
  ...
  # join tier assignments to the core table
  cores <- cores %>% 
