...
# The final table will have the following columns: study_id, site_id, core_id, attribute_name
...
# load in current version of the core attributes
if(file.exists("data/CCRCN_V2/core_attributes.csv")){
  current_core_attributes <-  read_csv("data/CCRCN_V2/core_attributes.csv")
  ...
  # run the function to extract core attributes
}
...
# Eleven Peck_et_al_2020 cores are not in the depthseries table

# write data to CCRCN V2 folder
write_csv(all_core_attributes, "data/CCRCN_V2/core_attributes.csv")
