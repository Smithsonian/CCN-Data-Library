...
write.csv(cores, "./data/Doughty_2016/derivative/Doughty_et_al_2016_cores.csv")
write.csv(depthseries, "./data/Doughty_2016/derivative/Doughty_et_al_2016_depthseries.csv")
write.csv(species, "./data/Doughty_2016/derivative/Doughty_et_al_2016_species.csv")
write.csv(doughty_pubs, "./data/Doughty_2016/derivative/Doughty_et_al_2016_associated_publications.csv")
write.csv(doughty_study_info, "./data/Doughty_2016/derivative/Doughty_et_al_2016_study_information.csv")
write.csv(doughty_keyword, "./data/Doughty_2016/derivative/Doughty_et_al_2016_keywords.csv")
write.csv(doughty_funding, "./data/Doughty_2016/derivative/Doughty_et_al_2016_funding_sources.csv")
write.csv(doughty_authors, "./data/Doughty_2016/derivative/Doughty_et_al_2016_authors.csv")
